...
def add_panoptic_deeplab_config(cfg):
    ...
    cfg.MODEL.INS_EMBED_HEAD.NAME = "PanopticDeepLabInsEmbedHeadKitti"
    ...
    # Panoptic-DeepLab prev instance segmentation head.
    cfg.MODEL.PREV_INS_EMBED_HEAD = CN()
    cfg.MODEL.PREV_INS_EMBED_HEAD.NAME = "PanopticDeepLabPrevInsEmbedHeadKitti"
    cfg.MODEL.PREV_INS_EMBED_HEAD.IN_FEATURES = ["res2", "res3", "res5"]
    cfg.MODEL.PREV_INS_EMBED_HEAD.PROJECT_FEATURES = ["res2", "res3"]
    cfg.MODEL.PREV_INS_EMBED_HEAD.PROJECT_CHANNELS = [32, 64]
    cfg.MODEL.PREV_INS_EMBED_HEAD.ASPP_CHANNELS = 256
    cfg.MODEL.PREV_INS_EMBED_HEAD.ASPP_DILATIONS = [6, 12, 18]
    cfg.MODEL.PREV_INS_EMBED_HEAD.ASPP_DROPOUT = 0.1
    # We add an extra convolution before predictor.
    ...
    cfg.MODEL.PREV_INS_EMBED_HEAD.HEAD_CHANNELS = 32
    cfg.MODEL.PREV_INS_EMBED_HEAD.CONVS_DIM = 128
    cfg.MODEL.PREV_INS_EMBED_HEAD.COMMON_STRIDE = 4
    cfg.MODEL.PREV_INS_EMBED_HEAD.NORM = "SyncBN"
    cfg.MODEL.PREV_INS_EMBED_HEAD.OFFSET_LOSS_WEIGHT = 0.01
