...
_PANOPTIC_PREDICTION_FORMAT = '%s_panoptic_prediction'
...
def pq_compute_single_core(proc_id, annotation_set, gt_folder, pred_folder, categories):
    ...
    for gt_ann, pred_ann in annotation_set:
        ...
        pan_gt_vis = pan_gt[:,:,0] * label_divisor + pan_gt[:,:,1] * 256 + pan_gt[:,:,2] 
        ...
        for label_tuple, intersection in gt_pred_map.items():
            ...
            union = pred_segms[pred_label]['area'] + gt_segms[gt_label]['area'] - intersection - gt_pred_map.get((VOID_GT, pred_label), 0)
        ...
        for pred_label, pred_info in pred_segms.items():
            ...
            intersection = gt_pred_map.get((VOID_GT, pred_label), 0)
