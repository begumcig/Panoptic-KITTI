...
from panoptic_utils import load_kitti
...
from dataset_mapper import PanopticDeeplabDatasetMapper, PanopticDeeplabTestMapper
from config import add_panoptic_deeplab_config
  
from detectron2.solver import get_default_optimizer_params
from detectron2.solver.build import maybe_add_gradient_clipping
from panoptic_seg import (
    PanopticDeepLabKitti,
    INS_EMBED_BRANCHES_REGISTRY,
    build_ins_embed_branch,
    PanopticDeepLabSemSegHeadKitti,
    PanopticDeepLabInsEmbedHeadKitti,
    PanopticDeepLabPrevInsEmbedHeadKitti,
    PREV_FRAME_INS_HEAD_REGISTRY, 
    build_prev_frame_ins_head,
)
...
class Trainer(DefaultTrainer):
    ...
    def build_test_loader(cls, cfg, dataset_name):
        mapper = PanopticDeeplabTestMapper(cfg)
